...
public class RoboJoint3 : MonoBehaviour
{
	...
	public Quaternion q2 = Quaternion.Euler(0f,0f,0f);
	...
	private void OnCollisionStay(Collision col){
		...
		//rb.velocity = new Vector3(0,0,0);
		//return; 
		if (this.GetComponent<Collider>().transform.root == col.collider.transform.root || col.collider.gameObject.name == "Terrain"){
			Debug.Log( "this: " + this.name + " is inside : " + col.collider.gameObject.name);
